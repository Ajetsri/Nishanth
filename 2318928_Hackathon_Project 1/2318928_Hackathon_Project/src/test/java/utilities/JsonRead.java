...
public class JsonRead {
	...
	public static JSONParser parser;      			// used for parsing the json data
	public static JSONObject jsonObject;   			// used for setting the data in a key Value pairs 
	public static Object obj;						// used for storing the data
